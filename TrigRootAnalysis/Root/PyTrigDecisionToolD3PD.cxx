// $Id: PyTrigDecisionToolD3PD.cxx 465546 2011-10-31 14:25:20Z krasznaa $
...
namespace D3PD {
    ...
    */
   PyTrigDecisionToolD3PD::PyTrigDecisionToolD3PD( TTree* eventTree, TTree* confTree,
   ...
   PyTrigDecisionToolD3PD::GetPassedTriggers( D3PD::TrigDefs::DecisionTypes type ) {
    ...
    */
   std::vector< std::string >
   PyTrigDecisionToolD3PD::GetPassedL1Triggers( D3PD::TrigDefs::DecisionTypes type ) {
    ...
    */
   std::vector< std::string >
   PyTrigDecisionToolD3PD::GetPassedL2Triggers( D3PD::TrigDefs::DecisionTypes type ) {
    ...
    */
   std::vector< std::string >
   PyTrigDecisionToolD3PD::GetPassedEFTriggers( D3PD::TrigDefs::DecisionTypes type ) {
    ...
    *          <code>kFALSE</code> otherwise
    */
   ::Bool_t PyTrigDecisionToolD3PD::WriteToTree( ::TTree* outputTree, ::Int_t detailLevel ) {
    ...
    */
   ::Int_t PyTrigDecisionToolD3PD::GetEntry( ::Long64_t entry, ::Int_t getall ) {
    ...
    */
   D3PD::TrigConfigSvcD3PD& PyTrigDecisionToolD3PD::GetConfigSvc() {

      return m_tdt.GetConfigSvc();
   }
