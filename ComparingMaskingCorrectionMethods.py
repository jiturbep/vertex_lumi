...
rootfiles = ["pmask_cache_LowMu10FitGs.root", "pmask_cache_LowMu15FitGs.root", "pmask_cache_16to30FitGs.root", "pmask_cache_31to45FitGs.root", "pmask_cache_46to60FitGs.root", "pmask_cache_AllNGenIntsFitGs.root"]
tags = ["2to10", "2to15", "16to30", "31to45", "46to60", "AllNGenInts"]
colors = [ROOT.kRed, ROOT.kMagenta+2, ROOT.kBlue, ROOT.kGreen, ROOT.kCyan+2, ROOT.kBlack]
