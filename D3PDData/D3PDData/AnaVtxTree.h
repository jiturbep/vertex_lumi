...
class AnaVtxTree : public VtxTree {
  ...
  protected:
    ...
    std::map<Int_t, std::map<Int_t, Float_t> > NVtxBeforeSplitCorrection_pertrack_perbcid;
    std::map<Int_t, Float_t> NVtxBeforeSplitCorrection_pertrack;
    ...
    std::map<Int_t, TH1F*>  h_nvtx_pertrack;
    std::map<Int_t, std::map<Int_t, TH1F*> > h_nvtx_pertrack_perbcid;
